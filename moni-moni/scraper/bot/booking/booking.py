...
class Booking(webdriver.Chrome):
    ...
    def enter_details(self, address, payment):
        ...
        element = self.find_element(
            by=By.XPATH, value='//*[@id="root"]/main/div/div[3]/button'
        )
        element.click()
        for i in payment:
            element = self.find_element(by=By.ID, value=i)
        ...
        element = self.find_element(
            by=By.XPATH, value='//*[@id="root"]/main/div/div[4]/button[2]'
        )
        element.click()
    ...
    def checkLinks(self):
        ...
        for i in links:
            ...
            if r.status_code == 400:
                ...
                print("Working link ", i.get_attribute("href"))
    ...
    def crawlData(self, url):
        ...
        element = self.find_elements(
            by=By.CLASS_NAME, value="CommunityFundraiserCard_community-campaign__CZjmd"
        )
        length = len(element)
        print(length)
        for i in range(1, length + 1):
            ...
            image = self.find_element(
                by=By.XPATH,
                value=f'//*[@id="main"]/section[6]/div[1]/ul/li[{i}]/a/div[1]',
            )
            ...
            title = self.find_element(
                by=By.XPATH,
                value=f'//*[@id="main"]/section[6]/div[1]/ul/li[{i}]/a/div[2]/h3',
            )
            desc = self.find_element(
                by=By.XPATH,
                value=f'//*[@id="main"]/section[6]/div[1]/ul/li[{i}]/a/div[2]/p',
            )
            fundingRaised = "".join(
                filter(
                    lambda i: i.isdigit(),
                    self.find_element(
                        by=By.XPATH,
                        value=f'//*[@id="main"]/section[6]/div[1]/ul/li[{i}]/a/div[2]/div/span[1]',
    ...
    def signup(self, details):
        ...
        element = self.find_element(
            by=By.XPATH, value='//*[@id="root"]/div/div[1]/header/div/div/div[3]/a'
        )
        element.click()
    ...
    def start_fundraiser(self, url, title, funding_req, desc, j):
        ...
        fundraiserOption = self.find_element(
            by=By.XPATH,
            value='//*[@id="root"]/div/div[2]/div/div/div/nav/div[4]/div[2]/span',
        )
        fundraiserOption.click()
        plusButton = self.find_element(
            by=By.CSS_SELECTOR, value='path[d = "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"]'
        )
        plusButton.click()
    ...
    def contribute_to_fundraiser(self, url, title, choice_of_funding):
        ...
        element = self.find_element(
            by=By.CSS_SELECTOR, value='input[placeholder="Search by fundraiser title"]'
        )
        element.send_keys(title)
        element = self.find_element(
            by=By.XPATH, value='//*[@id="root"]/div/div[2]/div/div/div[2]/a'
        )
        element.click()
        element = self.find_element(
            by=By.XPATH,
            value='//*[@id="root"]/div/div[2]/div/main/div[1]/div/div[2]/div/div[2]/div/a',
        )
        element.click()
        element = self.find_element(
            by=By.XPATH,
            value=f'//*[@id="root"]/div/div[2]/main[2]/div/div[{choice_of_funding}]/div/div[3]/button',
        )
        element.click()
    ...
    def get_fundraisers(self):
        element = self.find_element(
            by=By.XPATH, value='//*[@id="root"]/div/main/div[3]/div/div[1]'
        ).find_elements(by=By.CLASS_NAME, value="css-t1nuxs")
        print(len(element))
        for i in element:
