    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_total', models.DecimalField(decimal_places=2, default=32134424, max_digits=1000)),
                ('fund_remaining', models.DecimalField(decimal_places=2, default=4988, max_digits=1000)),
