    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_total', models.DecimalField(decimal_places=2, default=10456105, max_digits=1000)),
                ('fund_remaining', models.DecimalField(decimal_places=2, default=3851, max_digits=1000)),
